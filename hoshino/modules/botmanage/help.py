...
[谁艾特我] [谁艾特我帮助]       查看3天内被艾特的所有记录

[恶臭化+数字]       将任意数字以114514的格式呈现

[抽象一下+内容] [抽象话帮助]       将内容中部分字转为emoji表示

[淦翻译 XX]       能把中文翻译成淫语的翻译机！

[.rd] [掷骰子帮助]       简易骰娘，可用于roll点

[来点猫猫][来点狗狗][来点狐狸]
▲来点可爱猫/狗/狐图片(api不稳定,有可能获取失败)
...
[明日方舟帮助]明日方舟 模拟抽卡和蹲饼插件(作者停更，暂时停用)
================  当bot为管理员时可用  =================
[设置群名+新群名]       修改群名
